...
function($http, $window) {
	...
	auth.saveToken = function(token) {
		$window.localStorage['Lucie-blog-token'] = token;
	};

	auth.getToken = function() {
		return $window.localStorage['Lucie-blog-token'];
	}
	...
	auth.logOut = function() {
		$window.localStorage.removeItem('Lucie-blog-token');
	};
